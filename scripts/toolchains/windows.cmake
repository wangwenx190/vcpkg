...
if(NOT _CMAKE_IN_TRY_COMPILE)
    ...
    set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "/NOLOGO /DEBUG /INCREMENTAL:NO /OPT:REF /OPT:ICF /GUARD:CF ${VCPKG_LINKER_FLAGS}" CACHE STRING "")
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE "/NOLOGO /DEBUG /INCREMENTAL:NO /OPT:REF /OPT:ICF /GUARD:CF ${VCPKG_LINKER_FLAGS}" CACHE STRING "")
